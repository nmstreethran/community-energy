...
Regarding the impacts that they deem most important, they mentioned visual and
...
If N4 is developed, they anticipate that there will be no supply chain benefits
...
\begin{figure}
  ...
  \begin{subfigure}[t]{.9\textwidth}
    \fbox{\includegraphics[width=\textwidth]{images/plots/zs_height}}
    \caption*{Scenarios comparing varying turbine heights.}
  \end{subfigure}
  \\[.2cm]
  \begin{subfigure}[t]{.9\textwidth}
    \fbox{\includegraphics[width=\textwidth]{images/plots/zs_number}}
...
\begin{figure}
  \centering
  \fbox{\includegraphics[width=.9\textwidth]{images/plots/zs_elevation}}

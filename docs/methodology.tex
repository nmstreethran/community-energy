...
\begin{figure}
  \centering
  \includegraphics[width=.9\textwidth]{../images/plots/hist_dtm_n4}
...
\begin{figure}
  ...
  \begin{subfigure}[t]{.48\textwidth}
    \includegraphics[width=\textwidth]{../images/viewpoints/Calanais_Standing_Stones}
...
\begin{figure}
  ...
  ~
  \begin{subfigure}[t]{.48\textwidth}
    \includegraphics[width=\textwidth]{../images/viewpoints/Steinacleit}

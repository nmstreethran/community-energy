...
\begin{figure}
  \centering
  \frame{\includegraphics[width=.9\textwidth]{../images/plots/histogram}}
...
\begin{figure}
  \centering
  \frame{\includegraphics[width=.9\textwidth]{../images/plots/viewpoints_cc}}
...
\begin{figure}
  ...
  ~
  \begin{subfigure}[t]{.48\textwidth}
    \frame{\includegraphics[width=\textwidth]{../images/viewpoints/Bernera_Bridge}}
  ...
  \\[.5cm]
  \begin{subfigure}[t]{.48\textwidth}
    \frame{\includegraphics[width=\textwidth]{../images/viewpoints/Arnol_Blackhouse}}
  ...
  ~
  \begin{subfigure}[t]{.48\textwidth}
    \frame{\includegraphics[width=\textwidth]{../images/viewpoints/Loch_Barabhat}}
...
\begin{figure}
  \centering
  \begin{subfigure}[t]{.48\textwidth}
    \frame{\includegraphics[width=\textwidth]{../images/viewpoints/Dun_Carloway}}
  ...
  \\[.5cm]
  \begin{subfigure}[t]{.48\textwidth}
    \frame{\includegraphics[width=\textwidth]{../images/viewpoints/Taigh_a_Bheannaich}}
